                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('teacherYearClass')border border-danger rounded-3 @enderror">
                                    <select class="form-select" wire:model="teacherYearClass">
                                        ...
                                        <option value="{{$list_year->id}}">{{$list_year->md_year_class}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('teacherYearClass') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                @error('teacherPrefixTH') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="teacherFirstnameTH" class="form-control-label">{{ __('ชื่อ (TH)') }}</label>
                                ...
                                @error('teacherFirstnameTH') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                @error('teacherLastnameTH') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('teacherPrefixEN')border border-danger rounded-3 @enderror">
                                    <select class="form-select" wire:model="teacherPrefixEN">
                                        ...
                                        <option value="{{$list_eng->id}}">{{$list_eng->md_prefixname_eng}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('teacherPrefixEN') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="teacherFirstnameEN" class="form-control-label">{{ __('ชื่อ (EN)') }}</label>
                                ...
                                @error('teacherFirstnameEN') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                @error('teacherLastnameEN') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="mx-3" wire:click="deleteConfirm({{$list->ta_id}})">
                                                <i class="cursor-pointer fas fa-trash text-secondary"
                                                    aria-hidden="true"></i>
                                            </a>
                                            <a class="mx-3">
                                                <i class="cursor-pointer fas fa-key text-secondary"
                                                    aria-hidden="true"></i>
                                            </a>
                                        </td>
                                    </tr>
                ...
                <div class="modal-body">
                    <div class="card h-100">
                        <div class="card-body p-3">
                            <ul class="list-group">
                                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">ชื่อ -
                                        สกุล
