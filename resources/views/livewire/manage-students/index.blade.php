                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{$list->si_st_num}}</p>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="mx-3" wire:click="deleteConfirm({{$list->si_id}})">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="@error('studentClassYear')border border-danger rounded-3 @enderror">
                                        ...
                                        @error('studentClassYear') <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
