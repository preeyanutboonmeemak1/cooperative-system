    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h5 class="mb-0">{{ __('จับคู่สถานประกอบการกับนิสิต') }}</h5>
            </div>
                ...
                <div class="card">
                    <div class="d-flex flex-column mx-3 mt-3">
                        <div class="d-flex flex-row justify-content-between">
                            <div>
                                <h5 class="mb-0">รายชื่อข้อมูลนิสิตในสถานประกอบการ</h5>
                            </div>
                        ...
                        <div class="d-flex flex-row">
                            <div class="form-group {{ $errors->has('designation') ? ' has-error' : '' }}">
                                ...
                                <select id="designation" name="designation" class="form-control">
                                    ...
                                    <option value="{{$list_companys->sc_id}}">{{$list_companys->cp_name_en}}</option>
                                    @endforeach
                                </select>
                            </div>
                            &nbsp;
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" wire:click="find({{$list_companys->sc_id}}, {{$list_teachers->ta_id}}, {{$list_yearclass->id}}, {{$list_faculty->id}}, {{$list_course->id}})" class="btn bg-gradient-dark btn-md mt-4 mb-4">{{ 'ค้นหา' }}</button>
                            </div>
                        </div>
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-xs font-weight-bold align-middle">
                                        <span class="my-2 text-xs">{{$list_Companys->sc_id}}</span>
                                    </td>
                                    <td class="text-xs font-weight-bold align-middle">
                                        <span class="my-2 text-xs">{{$list_Companys->sc_st_num}}</span>
                                    </td>
                                    <td class="text-xs font-weight-bold align-middle">
                                        <span class="my-2 text-xs">{{$list_Companys->sc_name}}</span>
                                    </td>
                                    <td class="text-xs font-weight-bold align-middle">
                                        <span class="my-2 text-xs">{{$list_Companys->md_faculty}}</span>
                                    </td>
                                    <td class="text-xs font-weight-bold align-middle">
                                        <span class="my-2 text-xs">{{$list_Companys->md_course}}</span>
                                    </td>
                                    <td>
                                        <a href="#de" class="mx-3" type="button" wire:click="delete({{$list_Companys->sc_id}})" data-bs-toggle="modal" data-bs-target="#de" data-bs-original-title="Edit user">
                                            <span>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="form-label">
                                                <input type="checkbox" id="checkbox" class="{{ $list_students->si_id }}" name="checkbox[]" value="" required> <span class="label"></span>
                                            </label>
                                        </td>
                                        <td class="text-xs font-weight-bold align-middle">
