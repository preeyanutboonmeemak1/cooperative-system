<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('dashboard') }}">
            <img src="../assets/img/logo-se.jpeg" class="navbar-brand-img h-100" alt="...">
            <span class="ms-1 font-weight-bold">Cooperative System</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == `$item->mn_route_name` ? 'active' : '' }}"
                    href="{{ route($item->mn_route_name) }}">
                    <div
